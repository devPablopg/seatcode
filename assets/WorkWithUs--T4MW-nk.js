...
`,v=i.p`
  ...
  font-weight: 500;
  margin-bottom: 0;
  animation: ${U} 5s 750ms linear infinite;
`,j=i.p`
...
`,Y=i.div`
  ...
  ${D} {
    ...
    @media screen and (min-width: ${d+1}px) {
      img {
        height: max-content;
        max-height: 1300px;
      }
...
`,o=i.label`
  ...
  font-size: 1rem;
  font-family: SEATBCN-Condensed, sans-serif;
  color: ${r=>r.theme.colors.darkGray.rgba(.5)};
  pointer-events: none;
  ...
  &.error {
    color: ${r=>r.theme.colors.redAlert.hexa} !important;
  }
...
`,u=i.input`
  ...
  font-size: 1rem;
  background-color: ${r=>r.theme.colors.white.rgba(1)};
  border-radius: 5px;
  ...
  &:focus + ${o}, &:not(:placeholder-shown) + ${o} {
    top: -15px;
    left: 5px;
    font-size: 0.8rem;
...
`,H=i.select`
  ...
  appearance: none;
  box-sizing: border-box;
  color: ${r=>r.theme.colors.darkGray.rgba(.8)};
