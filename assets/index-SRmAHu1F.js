import{d as o,j as n}from"./index-CENDjnmR.js";import{T as a,a as s}from"./LocaleService-C19YxyPP.js";var r=(e=>(e.HOME="#/",e.ABOUT="#/about",e.OURSOLUTIONS="#/oursolutions",e.WORKWITHUS="#/workwithus",e.PARTNERSHIP="#/partnership",e.TERMS_OF_USE="#/terms-of-use",e.PRIVACY_POLICY="#/privacy-policy",e.INTEGRITY="#/integrity-and-compliance",e.ENVIRONMENTAL_POLICY="https://www.seat.com/company/environmental-policy.html",e.WHISTLEBLOWER="#/whistleblower-channel",e.CODE_LINKEDIN="https://www.linkedin.com/company/seatcode/posts/?feedView=all",e))(r||{});const l=o.div`
  display: block;
  margin-bottom: 2rem;
  text-align: center;
